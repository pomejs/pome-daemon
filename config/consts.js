...
consts.WELCOME_INFO = ["\nWelcome to the pome daemon.",
		"pome is a fast, scalable game server framework for node.js. ",
		"Type \'help\' for help information.\n"
];

consts.HELP_INFO_1 = [
		"\nFor information about pome products and services, visit:",
		"   http://pome.netease.com/",
		"\nList of all pome daemon commands:\n"
];
...
consts.COMANDS_ALL = [
	...
	["start", "  start pome server through daemon"]
];
...
consts.COMANDS_MAP = {
	...
	"kill": ["\nkill pomeo server through daemon",
			...
			"note: in pome serverId has the style of serverType-server-num",
			"so you can using following commands also",
			"start area-server-1",
			"start connector-server-1",
			"default environment is development\n"
	],
	"start": ["\nstart pome server through daemon",
...
consts.LOAD_ERROR = "Change your path to pome start path to load config files.\n";
